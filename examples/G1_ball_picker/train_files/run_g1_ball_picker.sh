...
data_mix=g1_ball_picker

run_root_dir=./results/Checkpoints_g1_ball_picker
run_id=dit4dit_g1_ball_picker
...
accelerate launch \
  ...
  --config_yaml ./DiT4DiT/config/g1_ball_picker/dit4dit_g1_ball_picker.yaml \
